...
Full module map and design rationale: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md). Host migration guide: [docs/MIGRATION.md → v7.1.0 → v7.1.1](docs/MIGRATION.md#v710--v711-bug-fix-patch) (latest — 27-bug correctness patch) and [v7.0 → v7.1](docs/MIGRATION.md#v70--v71-adr-0012).
