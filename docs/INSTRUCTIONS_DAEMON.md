...
The full env var table for v5.0 (covering the legacy v4 entries plus all v5 additions) lands in [`docs/CONFIGURATION.md`](./CONFIGURATION.md) with Phase 6.
...
- [`docs/TROUBLESHOOTING.md`](./TROUBLESHOOTING.md) — diagnostic guide for daemon symptoms.
- [`docs/llm-ux/ERROR_HANDBOOK.md`](./llm-ux/ERROR_HANDBOOK.md) (forthcoming) — every code, every cure.
